...
class TestGetSuccessMessageWhenSimpleDotation:
    @pytest.mark.parametrize(
        "dotation,expected_dotation_name",
        [
            (DOTATION_DSIL, "DSIL"),
            (DOTATION_DETR, "DETR"),
        ],
    )
    def test_accepted_status(
        self, collegue, client_with_user_logged, dotation, expected_dotation_name
    ):
        ...
        assert (
            f"La demande de financement avec la dotation {expected_dotation_name} a bien été acceptée avec un montant de 5\xa0000,00\xa0€."
            == message
        )
    ...
    def test_processing_status_with_refused_or_dismissed_simulation_status(
        ...
        assert (
            f"La demande de financement avec la dotation {expected_dotation_name} a bien été {verbe}. "
...
class TestGetSuccessMessageWhenDoubleDotation:
    ...
    def test_with_accepted_status_when_other_dotation_is_accepted(
        ...
        assert (
            f"La demande de financement avec la dotation {expected_dotation_name} a bien été acceptée avec un montant de 7\xa0500,50\xa0€."
            == message
        )
    ...
    def test_with_refused_status_when_other_dotation_is_refused(
        ...
        assert (
            f"La demande de financement avec la dotation {expected_dotation_name} a bien été refusée. "
            f"Le dossier a bien été mis à jour sur Démarche Numérique." == message
        )
    ...
    def test_with_dismissed_status_when_other_dotation_is_refused(
        ...
        assert (
            f"La demande de financement avec la dotation {expected_dotation_name} a bien été classée sans suite. "
            f"Le dossier a bien été mis à jour sur Démarche Numérique." == message
        )
