...
export class TipTapEditor extends Controller {
  ...
  static targets = ["source", "toolbarButton"]

  // TODO handle mention
  // TODO replace CONTENT_FIELD_NAME by a value
  ...
  setEditor(){
    console.log("this.hasSourceTarget", this.hasSourceTarget)
