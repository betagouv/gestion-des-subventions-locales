...
def sample_excel_file():
    ...
    ws.append(["01", "AIN", None, None, "pref@ain.gouv.fr", "Jean", "Dupont"])
    ws.append([None, None, None, None, "user1@ain.gouv.fr", "Marie", "Martin"])
    ws.append([None, None, None, None, "user2@ain.gouv.fr", "Pierre", "Durand"])
...
class TestExcelUserDataParser:
    def test_parse_hierarchical_structure(self, sample_excel_file, geographic_data):
        ...
        assert dataset[0] == ("pref@ain.gouv.fr", "01", None, "Jean", "Dupont")
        assert dataset[1] == ("user1@ain.gouv.fr", "01", None, "Marie", "Martin")
        assert dataset[2] == ("user2@ain.gouv.fr", "01", None, "Pierre", "Durand")
