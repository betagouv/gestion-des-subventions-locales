...
class TestSubEnveloppeSecurity:
    def test_can_only_edit_delegated_enveloppe(self):
        ...
        # Parent DETR envelope at departmental level
        ...
        # Non-delegated envelope in the same department (should NOT be editable)
        not_delegated = DetrEnveloppeFactory(perimetre=perimetre_dept, annee=2024)
        ...
        url_not_delegated = reverse(
            "gsl_projet:enveloppe-update", args=[not_delegated.id]
        )
