...
from gsl.core.api.data_gouv import get_dataset_api_url, get_latest_resource_url
...
class Command(BaseCommand):
    ...
    (`gsl.core.api.data_gouv.get_latest_resource_url`) pour toujours récupérer la
