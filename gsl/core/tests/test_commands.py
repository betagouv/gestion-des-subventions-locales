...
from gsl.core.management.commands.import_cog import COG_BASE_URL, COG_MILLESIME
from gsl.core.models import Arrondissement, Commune, Departement, Perimetre, Region
