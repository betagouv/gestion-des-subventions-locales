...
# -- _is_programmation_after_date_of_passage_en_instruction --


@pytest.mark.django_db
def test_is_programmation_after_date_of_passage_en_instruction_without_programmation():
    """Test _is_programmation_after_date_of_passage_en_instruction returns False when the dotation isn't programmed"""
    dotation_projet = DotationProjetFactory(status=PROJET_STATUS_PROCESSING)

    result = dps._is_programmation_after_date_of_passage_en_instruction(dotation_projet)

    assert result is False


@pytest.mark.django_db
def test_is_programmation_after_date_of_passage_en_instruction_when_before_passage_en_instruction():
    """Test _is_programmation_after_date_of_passage_en_instruction returns False when date_programmation is before ds_date_passage_en_instruction"""
...
@pytest.mark.django_db
def test_is_programmation_after_date_of_passage_en_instruction_when_after_passage_en_instruction():
    """Test _is_programmation_after_date_of_passage_en_instruction returns True when date_programmation is after ds_date_passage_en_instruction"""
    dossier = DossierFactory(
...
@pytest.mark.django_db
def test_is_programmation_after_date_of_passage_en_instruction_with_none_date():
    """Test _is_programmation_after_date_of_passage_en_instruction raises TypeError when ds_date_passage_en_instruction is None"""
    ...
    with pytest.raises(TypeError, match="not supported between instances of"):
        dps._is_programmation_after_date_of_passage_en_instruction(dotation_projet)
